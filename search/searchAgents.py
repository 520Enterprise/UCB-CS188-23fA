...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    "*** YOUR CODE HERE ***"
    # Go to the closest corner then go to the rest of the corners from edges
    min_distance = 0
    totoal_distance = 0
    ...
    for unvisited_corner in unvisited_corners:
        distance = util.manhattanDistance(current_position, unvisited_corner)
        if min_distance == 0 or distance < min_distance:
            min_distance = distance
            closest_corner = unvisited_corner
    totoal_distance += min_distance
